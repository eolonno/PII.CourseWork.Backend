...
namespace Business.Concrete
{
    public class CarImageManager : ICarImageService
    {
        ...
        public IResult Delete(CarImage carImage)
        {
            ...
            if (image == null) return new ErrorResult(Messages.NotFound);
        ...
        public IResult Update(IFormFile file, CarImage carImage)
        {
            ...
            if (imageToUpdate == null) return new ErrorResult(Messages.NotFound);

            var updatedFile = FileHelper.Update(file, imageToUpdate.ImagePath);
            if (!updatedFile.Success) return new ErrorResult(updatedFile.Message);
